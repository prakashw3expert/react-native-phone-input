...
import { Image, TextInput, TouchableWithoutFeedback, View, Text, TouchableOpacity } from "react-native";
...
export default class PhoneInput extends Component {
  ...
  getISOCode() {
    return this.state.iso2.toUpperCase();
  }
  ...
  render() {
    return (
      <View style={[styles.container, this.props.style]}>
        ...
        >
          <View>
            <Text style={this.props.isoStyle}>{this.getISOCode()}</Text>
          </View>
        
        <View style={{ flex: 1, marginLeft: this.props.offset || 10 }}>
            <Text style={this.props.isoStyle}>{formattedNumber}</Text>
          {/* <TextComponent
            ref={ref => {
              this.inputPhone = ref;
            }}
